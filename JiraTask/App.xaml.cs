...
namespace JiraTask
{
    ...
    public partial class App : Application
    {
        ...
        {
            var userSetting = UserSettingConfigHelper.GetUserSetting();
            CustomUtils.ProjectName = userSetting.ProjectName ?? string.Empty;
            CustomUtils.Account = userSetting.Account ?? string.Empty;
            CustomUtils.Password = userSetting.Password ?? string.Empty;
        }
        ...
        private void SetNotifyIcon()
        {
            ...
            this._notifyIcon.BalloonTipText = "Jira数据查看工具";
            this._notifyIcon.ShowBalloonTip(2000);
            this._notifyIcon.Text = "时时查看Jira相关数据";
